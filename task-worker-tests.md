...
tools: read,bash,edit,write,lsp-diagnostics,lsp-find-references,lsp-goto-definition,lsp-find-symbol,lsp-call-hierarchy,lint-files,write_todos,edit_todos,list_todos
---
